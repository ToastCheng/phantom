...
# -*- coding: utf-8 -*-
"""
Created on Tue Oct 24 14:57:25 2017
...
# set the distribution from 0.94 ~ 1.06
distribution = [30,10,0,0,0,0\
                ,20,\
                0,0,0,0,10,30]
...
for index in range(NUM_STEP):
    ...
    input_file = "output_DRS/simulation_" + str(index+13*4) + ".txt"
    ...
    weighted22 += data22*weight[index]
    weighted42 += data42*weight[index]
    weighted65 += data65*weight[index]
